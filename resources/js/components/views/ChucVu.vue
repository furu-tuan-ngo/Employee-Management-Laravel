            ...
            <div class="card-body py-0">
                ...
                <div class="table-responsive">
                    ...
                    >
                        <thead>
                            <tr class="text-left">
                                <th style="min-width: 200px">Tên Chức Vụ</th>

                                <th style="min-width: 150px">Lương Cơ Bản</th>
...
export default {
    ...
    methods: {
        handleRemove(item) {
            console.log(item);
            Swal.fire({
                title: `Xác nhận xóa chức vụ : ${item.name}`,
                text: "",
                icon: "warning",
                ...
                preConfirm: () => {
                    const chucvuModel = new CrudModel("chucvu");
                    return chucvuModel.delete(item.id).then(res => res);
                }
            }).then(result => {
                if (result.value) {
                    if (result.value.success) {
                        ...
                        Swal.fire(
                            "XÓA THÀNH CÔNG",
                            `Phòng ban: ${item.name} đã được xóa.`,
                            "success"
                        );
                    } else {
