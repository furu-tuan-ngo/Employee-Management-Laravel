            ...
            <div class="card-body py-0">
                ...
                <div class="table-responsive">
                    ...
                    >
                        <thead>
                            <tr class="text-left">
                                <th style="min-width: 200px">Tên Tôn Giáo</th>
...
export default {
    ...
    methods: {
        handleRemove(item) {
            console.log(item);
            Swal.fire({
                title: `Xác nhận xóa tôn giáo : ${item.name}`,
                text: "",
                icon: "warning",
                ...
                preConfirm: () => {
                    const tongiaoModel = new CrudModel("tongiao");
                    return tongiaoModel.delete(item.id).then(res => res);
                }
            }).then(result => {
                if (result.value) {
                    if (result.value.success) {
                        ...
                        Swal.fire(
                            "XÓA THÀNH CÔNG",
                            `Tôn giáo: ${item.name} đã được xóa.`,
                            "success"
                        );
                    } else {
