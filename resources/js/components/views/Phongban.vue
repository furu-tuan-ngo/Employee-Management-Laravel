<template>
    <div class="container">
        ...
        <div
            class="card card-custom card-stretch gutter-b card-shadowless p-0"
        >
            <!--begin::Header-->
            ...
            <div class="card-body py-0 p-0">
                ...
                <div class="table-responsive">
                    ...
                    >
                        <thead>
                            <tr class="text-left">
                                <th style="min-width: 200px">Tên Phòng Ban</th>
                                <th style="min-width: 150px">Diện Thoại</th>
                                <th style="min-width: 150px">Fax</th>
